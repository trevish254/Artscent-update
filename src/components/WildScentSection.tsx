...
export const WildScentSection: React.FC = () => {
  ...
  return (
    <section ref={ref} className="relative w-full">
      <div className="flex flex-col-reverse md:grid md:min-h-screen" style={{ gridTemplateColumns: '1fr 1fr' }}>
        {/* Child 1: Desktop video panel (hidden below md) */}
        <div
        ...
        >
          <video autoPlay muted loop playsInline className="absolute inset-0 w-full h-full object-cover">
            <source
              src="https://res.cloudinary.com/dfedn2xsg/video/upload/v1787529575/WhatsApp_Video_2026-08-24_at_2.51.40_AM_fugx6a.mp4"
              type="video/mp4"
            />
          </video>
        </div>
        ...
        {/* Child 3: ProductPanel (always visible, on right for desktop, visually top on mobile) */}
        <ProductPanel
          bg={BG_LIME}
...
export default WildScentSection;
